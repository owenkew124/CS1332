...
public class ArrayDeque<T> {
    ...
    public void addFirst(T data) {
        ...
        if (size == backingArray.length) {
            ...
            int i = 0;
            while (i < size) {
                int index = mod((size + i + front), backingArray.length);
    ...
    public T removeFirst() {
        if (size == 0) {
            throw new NoSuchElementException("The deque is empty and therefore no element can be removed");
        }
    ...
    public T removeLast() {
        ...
        int back = mod((front - 1 + size), backingArray.length);
    ...
    public T getFirst() {
        if (size == 0) {
            throw new NoSuchElementException("the deque is empty therefore no data can be gotten");
        }
    ...
    public T getLast() {
        ...
        return backingArray[mod((front - 1 + size), backingArray.length)];
    }
