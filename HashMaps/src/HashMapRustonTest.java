    ...
    public void testPutResizeWithRemoved() {
        ...
        for (int i = 0; i < table.length; i++) {
            if (table[i] == null) {
                ...
                System.out.println(i + " index " + table[i].getKey() + " key " + table[i].getValue() + " value " + table[i].isRemoved());
            }
        }
        ...
        for (int i = 0; i < expected.length; i++) {
            if (expected[i] == null) {
                ...
                System.out.println(i + " index " + expected[i].getKey() + " key " + expected[i].getValue() + " value " + expected[i].isRemoved());
            }
        }
        Assert.assertArrayEquals(expected, map.getTable());
        Assert.assertEquals(9, map.size());
